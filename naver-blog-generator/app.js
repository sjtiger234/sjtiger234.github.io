...
- 문장 종결은 "~요/~어요/~았어요"(해요체)와 "~습니다/~였습니다"(합쇼체)를 자연스럽게 섞은 정중하고 친근한 존댓말체로 쓸 것. "~였다/~했다/~한다/~적어본다" 같은 건조한 반말 서술체(평서체)는 쓰지 말 것 — 실제 파워블로거 글은 거의 전부 "~요/~습니다"체로 쓰여 있다. 한 문장 안에서 서로 다른 종결어미가 어색하게 이어 붙거나("~했는데는 ~였다" 같은 비문), 문장이 중간에 끊기는 일이 없도록 매끄럽게 다듬을 것`;
